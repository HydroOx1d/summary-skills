...
import { fetchArticleRecommendation } from "./fetchArticleRecommendation";

describe("testing fetch recommendation artcile feature", () => {
	test("should return data with resolved response", async () => {
		...
		const action = new TestAsyncThunk(fetchArticleRecommendation);
